...
<body>
    ...
    <div class="container">
        ...
        <h1 class="my-5 text-center h3">Chỉnh sửa phòng ban</h1>
        ...
        <form action="?controller=DepartmentController&action=update" method="POST">
            ...
            <div class="mb-3">
                ...
                <input value="<?= $department['name'] ?>" name="department_name" type="text" class="form-control" id="name" aria-describedby="emailHelp">
            </div>
